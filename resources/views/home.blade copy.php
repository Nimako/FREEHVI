        ...
        <div class="block">
            <div class="container">
                ...
                <div class="row" style="margin-bottom:20px">
                    <div class="col-md-3">
                        <div class="box2 style2 bgcolor2 text-center row">
                            ...
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                    
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center">
                            <h3 class="box-title">DIRECTOR 1</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/director1.jpg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center">
                            <h3 class="box-title">DIRECTOR 2</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/director2.jpeg')}}">
                                </div> 									
                                <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center ">
                            <h3 class="box-title">ENTREPRENEUR 1</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/entrepreneur1.jpg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-bottom:20px">
                    ...
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center row">
                            <h3 class="box-title">ENTREPRENEUR 2</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/entrepreneur2.jpeg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center ">
                            <h3 class="box-title">EXECUTIVE 1</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/executive1.jpeg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center ">
                            <h3 class="box-title">EXECUTIVE 2</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/executive2.jpg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="box2 style2 bgcolor2 text-center row">
                            <h3 class="box-title">GLOBAL LEADER 1</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/globalleader1.jpg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="box2 style2 bgcolor2 text-center row">
                            <h3 class="box-title">GLOBAL LEADER 2</h3>
                            <div class="box-icon">
                                <img class="img-responsive packages-img" src="{{asset('asset/images/packages/globalleader2.jpg')}}">
                            </div> 									
                            <div class="box-text"><b>GHS 100.0</b></div>
                        </div>
                    </div>
