        ...
        <div class="block">
            <div class="container">
                <ul class="breadcrumbs">
                    <li><a href="index-2.html"><i class="icon icon-home"></i></a></li>
    ...
    <div class="block">
        <div class="container">
            <div class="row">
                ...
                <img src="{{asset("asset/images/empty-cart.png")}}" width="160">
                    <br><br>
                    <p style="font-size:1.6em;font-weight:bolder"><b>Your cart is empty!</b></p>
                    <br>

                <a class="btn btn-primary btn-lg" href="{{url('/products')}}"> START SHOPPING</a>
                ...
                <div class="row">
                        ...
                        <form class="white" action="#">
                            <div class="radioset">
                                <label class="radio">
                                    ...
                                    <span class="outer"><span class="inner"></span></span><b>Standard Delivery</b> GH5.99 / Delivery in 5 to 7 business Days
                                </label>
                                <label class="radio">
                                    <input id="radioDelivery2" type="radio" name="radioDelivery" value="none">
                                    <span class="outer"><span class="inner"></span></span><b>Express Delivery</b> GH19.99 / Delivery in 1 business Days
                                </label>
                            </div>
                        </form>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="cart-table cart-table--sm">
                            ...
                            <div class="table-row">
                                <div class="photo">
                                    <a href="javascript:void()"><img src="<?= $row->attributes['featured_image']; ?>" alt=""></a>
                                </div>
                                <div class="name">
                                    <a href="javascript:void()"><?= $row->name; ?></a>
                                </div>
                                <div class="price">
                                    <?=  $row->price; ?>
                                </div>
